# Incluir este módulo le permite manipular sus propias instancias de elementos.
...
def show_items(self):   # 自身の所有するItemインスタンスの在庫状況を、["番号", "商品名", "金額", "数量"]という列でテーブル形式にして出力します。
    ...
    print(tabulate(table_data, headers=["número", "nombre del producto", "precio", "cantidad"], tablefmt="grid"))    # tabulateモジュールを使ってテーブル形式で結果を出力
